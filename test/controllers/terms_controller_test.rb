...
class TermsControllerTest < ActionController::TestCase
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post :create, term: { code: @term.code, end_date: @term.end_date, name: @term.name, start_date: @term.start_date }
    end
  ...
  test "should update term" do
    patch :update, id: @term, term: { code: @term.code, end_date: @term.end_date, name: @term.name, start_date: @term.start_date }
    assert_redirected_to term_path(assigns(:term))
  end
