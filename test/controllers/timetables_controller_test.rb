...
class TimetablesControllerTest < ActionController::TestCase
  ...
  test "should create timetable" do
    assert_difference('Timetable.count') do
      post :create, timetable: { end_date: @timetable.end_date, start_date: @timetable.start_date, term_id: @timetable.term_id }
    end
  ...
  test "should update timetable" do
    patch :update, id: @timetable, timetable: { end_date: @timetable.end_date, start_date: @timetable.start_date, term_id: @timetable.term_id }
    assert_redirected_to timetable_path(assigns(:timetable))
  end
