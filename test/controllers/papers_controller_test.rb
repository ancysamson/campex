...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { code: @paper.code, name: @paper.name, paper_type_id: @paper.paper_type_id, term_id: @paper.term_id }
    end
  ...
  test "should update paper" do
    patch :update, id: @paper, paper: { code: @paper.code, name: @paper.name, paper_type_id: @paper.paper_type_id, term_id: @paper.term_id }
    assert_redirected_to paper_path(assigns(:paper))
  end
